...
public class CarDictActivity extends BaseActivity {
    ...
    public void getData() {
        ...
        paras.put("brandId", brandId);
        RequestUtil requestUtil = new RequestUtil();
        requestUtil.requestGetByParmarts(HttpConstant.CAR_MODEL_DICT_URL, paras, new IHttpResponse() {
            @Override
...
//                    .setText(R.id.tv_content, item.getDictCode() + "")
